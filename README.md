...
- **[MidasFlow Flow API](https://github.com/midasflowai-lab/midasflow-mcp-quickstart)** - Agent-native crypto market data: order flow, whale tracking, liquidations, pump detection and calibrated scores for AI agents, via remote MCP at https://mcp.midasflow.ai/mcp
